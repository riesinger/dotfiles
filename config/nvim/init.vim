...
Plug 'mattn/calendar-vim'                   " It's a calendar. In Vim
Plug 'nathanaelkane/vim-indent-guides'      " Useful for languages like YAML
Plug 'neoclide/coc.nvim', { 'branch': 'release' } " A LSP client
Plug 'puremourning/vimspector'              " The vim debugger
...
Plug 'tpope/vim-repeat'                     " Make (almost) all commands repeatable
Plug 'tpope/vim-sleuth'                     " Guess the indentation settings
Plug 'tpope/vim-surround'                   " Surround things by other things
Plug 'tpope/vim-unimpaired'                 " More useful mappings
Plug 'vimwiki/vimwiki'                      " My knowledge base
...
:autocmd FileType vimwiki map <leader>q :VimwikiDiaryPrevDay<cr>
...
" I am German and my calendar should be too :)
